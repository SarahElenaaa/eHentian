            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Pilih Meja</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Tempah Meja</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Pesan dan Bayar</a></li>
                        
                    </ul>
                </div>
            </div>
            <?php $ress= mysqli_query($db,"select * from all_table where t_id='$_GET[res_id]'");
    ...
    <div class="row">
            ...
            <div class="widget widget-cart">
                ...
                <div class="order-row bg-white">
                    <div class="widget-body">
                        ...
                        foreach ($_SESSION["cart_item"] as $item) {
                            ...
                            <div class="title-row">
                                <?php echo $item["title"]; ?>
                                <a href="table.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["t_id"]; ?>">
                ...
                <div class="widget-body">
                    <div class="price-wrap text-xs-center">
                        ...
                        if ($item_total == 0) {
                            ?>
                            <a href="checkout.php?res_id=<?php echo $_GET['res_id']; ?>&action=check" class="btn theme-btn btn-lg disabled">Tempah Sekarang</a>
                            <?php
                        } else {
                            ?>
                            <a href="checkout.php?res_id=<?php echo $_GET['res_id']; ?>&action=check" class="btn theme-btn btn-lg active"Tempah Sekarang</a>
                            <?php
                        }
                        ?>
                    </div>
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
            <div class="menu-widget" id="2">
                ...
                <?php  
									$stmt = $db->prepare("select * from all_table where t_id='$_GET[res_id]'");
									$stmt->execute();
                            ...
                            <div class="food-item">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-lg-8">
                                        <form method="post" action="table.php?res_id=<?php echo $_GET['res_id']; ?>&action=add&id=<?php echo $product['t_id']; ?>">
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#">
                                                    <img src="admin/Res_img/dishes/<?php echo $product['images']; ?>" alt="Table logo">
                                                </a>
                                            </div>
                                            <div class="rest-descr">
                                                <h6><a href="#"><?php echo $product['table_name']; ?></a></h6>
                                                <p><?php echo $product['description']; ?></p>
                                            </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info">
                                        <span class="price pull-left">Bilangan <?php echo $product['table_deposit']; ?></span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn theme-btn">Tambah ke Troli</button>
                </div>
            </div>
        </div>
    </div>
