...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/bg_main.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Selamat Datang Ke Restoran Hentian! </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Pesan Makanan</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Tempah Meja</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Nikmati Pesanan Anda</h4> </div>
                    </div>
                    <br>
                </div>
            </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Jangan lepaskan peluang anda mencuba!</p>
                </div>
                <div class="row">
						<?php 					
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">RM'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Pesan Sekarang</a> </div>
                                                </div>
						...
						?>
                        <div class="price-btn-block" style="text-align: center;"><a href="restaurants.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash" style="display: inline-block; width: 200px; text-align: center;">Lihat Menu</a></div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>Pesan Sekarang, di Hujung Jari Saja!</h2>
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Pilih Kategori Makanan</h3>
                                    <p>Kami pasti akan dapat memberikan pengalaman yang anda tidak boleh lupakan!</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Pilih Pesanan Anda</h3>
                                <p>Pelbagai pilihan makanan yang bakal menarik minat anda!</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Tidak Perlu Menunggu</h3>
                                <p>Dapatkan makanan anda tanpa perlu menunggu giliran, pesan saja di laman web ini! </p>
                            </div>
                        </div>
                    </div>
                </div>
